        ...
        return (
            <div>
                ...
                <ul>
                    ...
                    <li class="strike">Convert NoteItem, AddNewTag, TagItem and TagList from class components to functional components</li>
                    <li class="strike">Use hooks in Tags, AddNewTag and TagList functional components for working with state and effect</li>
                    <li class="strike">Allow user to edit tag name/note text inline</li>
                    <li class="strike">Save tag name/note text changes to DB</li>
                    <li class="strike">Add checkboxes to tags</li>
